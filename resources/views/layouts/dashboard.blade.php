...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
      ...
      <title>{{ $title }} | SI Perpustakaan 40 </title>
      ...
      <footer class="footer">
          <div class="footer-body">
              ...
              <div class="right-panel">
                  ©<script>document.write(new Date().getFullYear())</script> Sistem Informasi Perpustakaan 40, Made with
                  <span class="">
                  ...
                  </span> by <a href="https://iqonic.design/">Nkymko</a>.
              </div>
          </div>
      </footer>
      <!-- Footer Section End -->    
